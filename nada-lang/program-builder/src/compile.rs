    ...
    I: IntoIterator<Item = P>,
{
    ...
    // Use a couple of specific directories to avoid pulling in paths that change on every build
    // because of protobuf.
    rebuild_if_modified_files(&nada_dsl_path.join("nada_mir/proto"));
    rebuild_if_modified_files(&nada_dsl_path.join("nada_mir/src/nada_mir_proto"));
