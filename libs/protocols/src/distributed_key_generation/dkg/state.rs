...
pub struct RoundStateMessage {
    msg: Msg<Secp256k1, SecurityLevel128, Sha256>,
    msg_type: KeyGenStateMessageType,
}
...
impl PartialEq for RoundStateMessage {
    fn eq(&self, other: &Self) -> bool {
        ...
        match (&self.msg, &other.msg) {
            ...
            (Msg::Round1(_), Msg::Round1(_)) => true,
                ...
                match result {
                    ...
                    EcdsaKeyGenOutgoingMessage::Output(output) => {
                        ...
                        return match output {
                            ...
                            Err(error) => {
                                Ok(StateMachineStateOutput::Final(EcdsaKeyGenOutput::Abort { reason: error }))
                            }
                        };
                    }
        ...
        for message in outgoing_messages {
            let recipient_message = match message.recipient {
                MessageDestination::AllParties => {
                    let msg = RoundStateMessage { msg: message.msg, msg_type: KeyGenStateMessageType::Broadcast };
                ...
                MessageDestination::OneParty(party_index) => {
                    ...
                    let msg = RoundStateMessage { msg: message.msg, msg_type: KeyGenStateMessageType::P2P };
