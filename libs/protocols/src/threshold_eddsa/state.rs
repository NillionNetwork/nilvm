...
/// Threshold EdDSA round1 state machine.
...
pub mod states {
    ...
    /// and to receive a message to sign
...
impl EddsaSignState {
    ...
    pub fn new(
        ...
        let message = RecipientMessage::new(Recipient::Multiple(sorted_parties.parties()), Msg::Round1(commits));
    ...
    fn transition_waiting_public_commits(state: states::WaitingPublicCommits) -> StateMachineStateResult<Self> {
        ...
        // Build signers = [(signerIndex, PublicCommits)]
...
/// An error during the EdDSA state construction.
#[derive(thiserror::Error, Debug)]
pub enum EddsaCreateError {}
