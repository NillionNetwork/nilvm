//! End-to-end tests for the TRUNCPR protocol.

#![allow(clippy::arithmetic_side_effects, clippy::indexing_slicing)]

use super::protocol::TruncPrProtocol;
...
fn end_to_end() {
    ...
    // The numbers we'll apply probabilistic truncation: (dividend, m) for dividend mod 2^m
    let numbers = vec![
    ...
    let protocol = TruncPrProtocol::<U64SafePrime>::new(numbers, polynomial_degree, kappa, k);
...
fn end_to_end_large_divisor_error() {
    ...
    // The numbers we'll apply probabilistic truncation
