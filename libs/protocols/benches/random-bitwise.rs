...
use protocols::{
    random::random_quaternary::protocol::RanQuaternaryProtocol, simulator::symmetric::SymmetricProtocolSimulator,
};
...
impl Config {
        ...
        ShamirSecretSharer<T>: SafePrimeSecretSharer<T>,
    {
        ...
        let protocol = RanQuaternaryProtocol::<T>::new(self.element_count, self.polynomial_degree);
        move || {
