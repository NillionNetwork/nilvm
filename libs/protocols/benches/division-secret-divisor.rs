...
use protocols::{
    division::division_secret_divisor::offline::protocol::PrepDivisionIntegerSecretProtocol,
...
impl Default for Config {
    ...
    fn default() -> Self {
        ...
        // The size of elements, i.e. integer bit width. (PRIME.bits() - kappa - 1) / 2.
        let k = 107;
...
impl Config {
        ...
        ShamirSecretSharer<T>: SafePrimeSecretSharer<T>,
    {
        ...
        let protocol =
            PrepDivisionIntegerSecretProtocol::<T>::new(self.element_count, self.polynomial_degree, self.kappa, self.k);
        move || {
...
benchmark_property!(bench_element_count, U256SafePrime, element_count, [1, 10]);
