...
use protocols::{
    conditionals::less_than::offline::protocol::PrepCompareProtocol, simulator::symmetric::SymmetricProtocolSimulator,
};
...
impl Default for Config {
    ...
    fn default() -> Self {
        ...
        Self { polynomial_degree, element_count, network_size }
    }
}
...
impl Config {
        ...
        ShamirSecretSharer<T>: SafePrimeSecretSharer<T>,
    {
        ...
        let protocol = PrepCompareProtocol::<T>::new(self.element_count, self.polynomial_degree);
        move || {
